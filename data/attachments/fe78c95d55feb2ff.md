...
- Name: 07-invoices.spec.js >> Service 08 — Invoices & Account Management >> TC_08_10 — Clicking "Details" on the first invoice navigates to its detail page
- Location: tests/07-invoices.spec.js:81:9
