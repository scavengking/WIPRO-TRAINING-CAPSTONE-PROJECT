...
- Name: 04-profile.spec.js >> Service 4 - User Profile & Navigation (Logged-In) >> TC_Nav_01 - Verify all user dropdown links are visible
- Location: tests/04-profile.spec.js:18:9
