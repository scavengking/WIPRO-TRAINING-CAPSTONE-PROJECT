...
- Name: 07-invoices.spec.js >> Service 08 — Invoices & Account Management >> TC_08_08 — First invoice record shows an INV- prefixed invoice ID
- Location: tests/07-invoices.spec.js:66:9
