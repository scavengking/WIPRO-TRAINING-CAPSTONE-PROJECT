...
- Name: 07-invoices.spec.js >> Service 08 — Invoices & Account Management >> TC_08_01 — User nav-menu button is visible after successful login
- Location: tests/07-invoices.spec.js:21:9
