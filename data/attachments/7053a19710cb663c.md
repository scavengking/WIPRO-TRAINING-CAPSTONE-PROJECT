...
- Name: 07-invoices.spec.js >> Service 08 — Invoices & Account Management >> TC_08_09 — Every invoice row has a visible "Details" button
- Location: tests/07-invoices.spec.js:73:9
