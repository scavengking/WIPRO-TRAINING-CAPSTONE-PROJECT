...
- Name: 05-checkout.spec.js >> Service 5 & 6 - Checkout Suite >> TC18_Neg - Guest form requires email when only names are provided
- Location: tests/05-checkout.spec.js:250:9
