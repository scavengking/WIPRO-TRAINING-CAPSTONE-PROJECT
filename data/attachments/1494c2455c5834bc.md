...
Error: locator.textContent: Error: strict mode violation: locator('.alert, .help-block, [data-test="login-error"]') resolved to 2 elements:
    1) <div id="email-error" data-test="email-error" class="alert alert-danger" _ngcontent-ng-c713820125="">…</div> aka locator('[data-test="email-error"]')
    2) <div id="password-error" data-test="password-error" class="alert alert-danger" _ngcontent-ng-c713820125="">…</div> aka locator('[data-test="password-error"]')
